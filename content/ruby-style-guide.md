...
This guide is adapted from the [Rubocop Style Guide](https://github.com/rubocop-hq/ruby-style-guide) which is licensed under a 
[Creative Commons Attribution 3.0 Unported License](http://creativecommons.org/licenses/by/3.0/deed.en_US).
and the [Shopify Ruby Guide](https://shopify.github.io/ruby-style-guide/).
It is a living document that is expected to change and adapt to best practices
and language features.  A default configuration can be inherited in you rubocop
configuration by adding the following code to your `.rubocop.yml` file:

```
inherit_from:
  - https://ctx.sh/ruby-style-guide/rubocop.yml
```
